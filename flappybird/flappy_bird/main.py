...
BASE_IMG = pygame.transform.scale2x(pygame.image.load(os.path.join("C:\\Users\\Nick\\OneDrive\\Documents\\python_game\\flappy_bird\\imgs_b286d95d6d\\imgs", "pipe.png")))
BG_IMG = pygame.transform.scale2x(pygame.image.load(os.path.join("C:\\Users\\Nick\\OneDrive\\Documents\\python_game\\flappy_bird\\imgs_b286d95d6d\\imgs", "pipe.png")))
